...
type Config struct {
	...
	AuthHosts              []DomainInfo         `long:"auth-hosts" env:"AUTH_HOSTS" env-delim:"," description:"Single host to use when returning from 3rd party auth"`
	ForwardHttps           bool                 `long:"forward-https" env:"FORWARD_HTTPS" description:"Enforce https forwarding"`
